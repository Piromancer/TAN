...
public:
	...
	void Init(bool consoleMode, const std::string & configFile, const std::string & metricsFile, 
		const std::string & outputFile, size_t playDuration);
	void run_in_console(int playDuration);
